...
export default function Sidebar() {
  return (
    <div className="fixed h-screen w-20 lg:w-64 border-r border-zinc-800 flex flex-col justify-between py-6 px-2 bg-black text-white">
            ...
            iconSrc={
              ...
              >
                ...
                <path
                  strokeLinecap="round"
                  strokeLinejoin="round"
                  d="M16.25 7.75l-2.75 6.5-6.5 2.75 2.75-6.5 6.5-2.75z"
                />
              </svg>
            }
            label="Explore"
      ...
      <div className="px-2">
        <a
          target="_blank"
          href="https://www.threads.net/?xmt=AQGz01fA2Q5ASF7S9c-BY-rshvUh-JEkt2xXeLTUsIUOBMg"
        >
          <SidebarItem
            iconSrc={
              <svg
